...
const int INPUT_WIDTH = 32; // 输入图片的长宽
const int MNISI_HEIGHT = 28;
const int MNISI_WIDTH = 28; // MNIST图片的长宽
const int PADDING_SIZE = 2; // 填充大小
const int OUTPUT_SIZE = 10; // 输出大小
const int TRAIN_NUM = 3000; // 训练集大小
const int TEST_NUM = 100;   // 测试集大小
using namespace std;
